  ...
  <StaticQuery
    ...
    render={(data) => (
      <div className="bg-secondary flex flex-column justify-center items-center px-10 py-20 text-near-white leading-relaxed text-center">
        ...
        <Button.PrimaryWithPageChange to="mailto:daniela.sohneg@gmail.com" classNames="mt-6 no-underline  text-near-white" colorClassName="bg-dark-gray">E-Mail an Daniela</Button.PrimaryWithPageChange>
      </div>
    )}
  />
);
