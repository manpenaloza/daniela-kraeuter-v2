...
export default () => (
  <Layout>
    ...
    <div className="lh-copy f4 serif mw8 center">
      <p>
        Gatsby Starter Tyra ("us", "we", or "our") operates the
        gatsby-starter-tyra.netlify.com website (the "Service").
      </p>
      <p>
        This page informs you of our policies regarding the collection, use, and
        disclosure of personal data when you use our Service and the choices you
        have associated with that data. Our Privacy Policy for Gatsby Starter
        Tyra is based on the{" "}
        <a
          className="light-red"
      ...
      <p>
        ...
        gatsby-starter-tyra.netlify.com
      </p>
      ...
      <p>
        Gatsby Starter Tyra will take all steps reasonably necessary to ensure
      ...
      <p>
        Gatsby Starter Tyra may disclose your Personal Data in the good faith
        belief that such action is necessary to:
      </p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>
          To protect and defend the rights or property of Gatsby Starter Tyra
        </li>
        <li>
